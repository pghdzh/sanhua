  ...
  <div class="yuzuki-resources">
    ...
    <header class="hero">
      <div class="hero-inner">
        <h1>资源分享</h1>
        <p class="subtitle">可自由上传关于散华的相关链接</p>
      </div>
    </header>
...
$text: #dbeefb; // 浅冰色主文字（深底上）
$muted: rgba(219, 234, 247, 0.58);

$card-border: rgba(120, 208, 255, 0.04);
...
.yuzuki-resources {
  ...
  background: radial-gradient(
    ...
    radial-gradient(circle at 78% 70%, rgba($ice, 0.015), transparent 8%),
    linear-gradient(180deg, $bg-deep 0%, $bg-mid 100%);
  min-height: 100vh;
  position: relative;
  overflow: hidden;
}
...
.carousel {
  ...
  .carousel-image {
    ...
    height: 100%;
    object-fit: cover;
    filter: blur(0.8px) saturate(0.85) brightness(0.92);
    opacity: 0;
...
.hero {
  ...
  h1 {
    ...
    text-shadow: 0 8px 20px rgba(2, 6, 10, 0.6);
...
.uploader {
  ...
  border: 1px solid rgba($accent, 0.03);
  background: linear-gradient(
    180deg,
    rgba(8, 12, 16, 0.36),
    rgba(6, 10, 14, 0.44)
  ...
  .toggle {
    ...
    transition: transform 160ms ease, box-shadow 160ms ease, background 180ms;
  }
  ...
  .upload-form {
    ...
    .row {
      ...
      textarea {
        ...
        font-weight: 600;
        outline: none;
        transition: box-shadow 160ms, border-color 160ms, transform 80ms;
      ...
      textarea:focus {
        border-color: $accent;
        box-shadow: 0 10px 30px rgba($accent, 0.06);
    ...
    .actions {
      ...
      .btn.primary {
        background: linear-gradient(
          135deg,
          $accent 0%,
          rgba($scarlet, 0.56) 100%
        );
        color: #041018;
        box-shadow: 0 10px 30px rgba(12, 18, 22, 0.36);
      }
      .btn.primary:hover {
      ...
      .btn.secondary {
        background: transparent;
        color: $muted;
        border: 1px solid rgba($scarlet, 0.04);
      }
...
.list {
  ...
  .item {
    ...
    box-shadow: 0 8px 28px rgba(2, 4, 8, 0.46);

    &:hover {
      transform: translateY(-6px);
      box-shadow: 0 18px 48px rgba(3, 8, 14, 0.68);
    }
    ...
    .meta {
      ...
      .right {
        ...
        .like-btn.active .heart-icon {
          ...
          box-shadow: 0 6px 20px rgba($accent, 0.12);
        }
