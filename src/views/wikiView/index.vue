...
$deep-2: #0b2432; // 冷雾灰蓝
$accent-1: #5fa6c9; // 散华主色：冷雾青蓝
$accent-2: #b8d6e8; // 次高光：月光浅蓝
$text-main: #dbeefb; // 冷墨黑
$muted: rgba($text-main, 0.62);

$card-1: #0b2432; 
$card-0: rgba(120, 208, 255, 0.08);

$gap-overlay-1: rgba(6, 10, 18, 0.12);
$gap-overlay-2: rgba(6, 10, 18, 0.18);

$border-weak: rgba(20, 40, 60, 0.08);
$accent-glow: rgba(95, 166, 201, 0.12);

$danger: #e45c5c;

$shadow-dark: rgba(10, 18, 30, 0.18);
$inset-glow: rgba(95, 166, 201, 0.04);
