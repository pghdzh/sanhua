...
$ice: #e6f8ff; // 冰光高亮
$cold: #6fd0ff; // 冷蓝反光
$scarlet: #c84b4b; // 猩红点缀（谨慎使用）

$text-light: #dbeefb; // 浅冰色主文字（深底上）
$text-muted: rgba(219, 234, 247, 0.54);

$card-border: rgba(111, 208, 255, 0.04);
$soft-shadow: rgba(3, 8, 14, 0.72);
$glass: rgba(8, 12, 18, 0.56);
...
.cantarella-player {
  ...
  background: radial-gradient(
    ...
    linear-gradient(180deg, $bg-mid 0%, $bg-deep 100%);
  color: $text-light;
  padding-top: 84px;
...
.left {
  ...
  border-radius: 12px;
  padding: 14px;
  box-shadow: 0 14px 40px rgba(2, 6, 10, 0.72);
  position: relative;
  min-height: 380px;
}

/* cover 区：保留媒体但改为暗淡画框 + 冰光点缀 */
.cover {
  width: 100%;
  height: 560px;
  border-radius: 10px;
  background: linear-gradient(135deg, rgba($cold, 0.02), rgba($scarlet, 0.01));
  display: flex;
  align-items: center;
  justify-content: center;
  overflow: hidden;
  position: relative;
  box-shadow: inset 0 -6px 20px rgba(0, 0, 0, 0.24);
  border: 1px solid rgba(255, 255, 255, 0.02);
}
...
.loading-overlay {
  ...
  align-items: center;
  justify-content: center;
  background: linear-gradient(180deg, rgba(2, 4, 8, 0.4), rgba(4, 6, 10, 0.6));
  z-index: 8;
}
.spinner,
.small-spinner {
...
.progress {
  height: 100%;
  width: 0%;
  background: linear-gradient(90deg, $cold 0%, rgba($scarlet, 0.06) 100%);
  box-shadow: 0 4px 12px rgba($cold, 0.06) inset;
...
.progress-handle {
  ...
  position: relative;
  top: -3px;
  box-shadow: 0 8px 20px rgba($cold, 0.14);
...
.play {
  font-size: 20px;
  background: linear-gradient(90deg, rgba($cold, 0.04), rgba($scarlet, 0.02));
  padding: 8px 12px;
  border-radius: 12px;
  box-shadow: 0 8px 28px rgba(2, 6, 10, 0.36);
}
.icon:hover,
.play:hover {
...
.modes .active {
  background: linear-gradient(90deg, rgba($cold, 0.06), rgba($scarlet, 0.02));
  border-color: rgba($cold, 0.12);
}
...
.right {
  ...
  overflow: hidden;
  border-radius: 12px;
  background: linear-gradient(180deg, rgba(6, 8, 10, 0.84), rgba(4, 6, 8, 0.9));
  border: 1px solid rgba(255, 255, 255, 0.02);
  padding: 12px;
  box-shadow: 0 14px 36px rgba(2, 6, 10, 0.72);
  display: flex;
  flex-direction: column;
...
.search-wrap input {
  ...
  border-radius: 10px;
  border: 1px solid rgba(255, 255, 255, 0.02);
  background: linear-gradient(180deg, rgba(6, 8, 10, 0.6), rgba(4, 6, 8, 0.6));
  color: $text-light;
  width: 220px;
...
.playlist li:hover {
  ...
  background: linear-gradient(90deg, rgba($cold, 0.03), rgba($scarlet, 0.01));
}

/* 选中态动效：冷光扫过 + 微光脉冲 */
.playlist li.active {
  background: linear-gradient(90deg, rgba($cold, 0.06), rgba($scarlet, 0.03));
  box-shadow: 0 10px 30px rgba($cold, 0.08), inset 0 4px 18px rgba($cold, 0.02);
  border: 1px solid rgba($cold, 0.12);
  position: relative;
  animation: selected-glow 1800ms ease-in-out infinite;
}
@keyframes selected-glow {
  0% {
    box-shadow: 0 8px 24px rgba($cold, 0.06), inset 0 2px 12px rgba($cold, 0.01);
    transform: translateX(0);
  }
  50% {
    box-shadow: 0 18px 40px rgba($cold, 0.12),
      inset 0 6px 22px rgba($cold, 0.03);
...
.dot {
  ...
  height: 10px;
  border-radius: 50%;
  background: linear-gradient(90deg, $scarlet, $cold);
  box-shadow: 0 6px 14px rgba($cold, 0.06);
  flex: 0 0 auto;
}
.title {
  font-weight: 700;
